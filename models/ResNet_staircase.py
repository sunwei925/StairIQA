...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.quality1 = self.quality_regression(2048,1)
        self.quality2 = self.quality_regression(2048,1)
        self.quality3 = self.quality_regression(2048,1)
        self.quality4 = self.quality_regression(2048,1)
        self.quality5 = self.quality_regression(2048,1)
        self.quality6 = self.quality_regression(2048,1)
    ...
    def quality_regression(self,in_channels,out_channels):
